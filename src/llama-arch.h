...
enum llm_tensor {
    ...
    LLM_TENSOR_ATTN_QKV,
    LLM_TENSOR_ATTN_OUT,
    LLM_TENSOR_ATTN_Q_DIFF,
    LLM_TENSOR_ATTN_K_DIFF,
    LLM_TENSOR_ATTN_V_DIFF,
    LLM_TENSOR_ATTN_OUT_DIFF,
    ...
    LLM_TENSOR_ATTN_Q_NORM_DIFF,
    LLM_TENSOR_ATTN_K_NORM_DIFF,
