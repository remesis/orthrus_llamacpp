...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_DIFFUSION_BLOCK_SIZE,              "%s.diffusion.block_size"              },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_Q_DIFF,                            "blk.%d.attn_q_diff" },
    { LLM_TENSOR_ATTN_K_DIFF,                            "blk.%d.attn_k_diff" },
    { LLM_TENSOR_ATTN_V_DIFF,                            "blk.%d.attn_v_diff" },
    { LLM_TENSOR_ATTN_OUT_DIFF,                          "blk.%d.attn_output_diff" },
    ...
    { LLM_TENSOR_ATTN_Q_NORM_DIFF,                       "blk.%d.attn_q_norm_diff" },
    { LLM_TENSOR_ATTN_K_NORM_DIFF,                       "blk.%d.attn_k_norm_diff" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ATTN_Q_DIFF,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_K_DIFF,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_V_DIFF,                {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_ATTN_OUT_DIFF,              {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    ...
    {LLM_TENSOR_ATTN_Q_NORM_DIFF,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_ATTN_K_NORM_DIFF,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
